# bankbot_integrated.py - BankBot AI with Admin Panel
# Infosys Springboard Project - Complete Integrated System
...
if st.session_state.user_type == "admin":
    ...
    # ANALYTICS PAGE
        ...
        if data is None:
            ...
            st.dataframe(stats_df, width=None, hide_index=True)
